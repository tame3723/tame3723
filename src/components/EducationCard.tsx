        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-brand-textSecondary mt-1 font-medium text-sm">{edu.degree}</p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pl-2 pt-2">
            <div className="flex items-center gap-2 text-sm text-brand-textSecondary">
              <ChevronRight size={16} className="text-brand-accent shrink-0" />
              <span>Specialization: <strong className="text-brand-textPrimary font-semibold">{edu.specialization}</strong></span>
            </div>
            {edu.minor && (
              <div className="flex items-center gap-2 text-sm text-brand-textSecondary">
                <ChevronRight size={16} className="text-brand-accent shrink-0" />
                <span>Minor Focus: <strong className="text-brand-textPrimary font-semibold">{edu.minor}</strong></span>
              </div>
            )}
            <div className="flex items-center gap-2 text-sm text-brand-textSecondary">
              <ChevronRight size={16} className="text-brand-accent shrink-0" />
